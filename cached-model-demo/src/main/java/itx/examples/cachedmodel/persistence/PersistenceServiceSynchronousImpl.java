...
public class PersistenceServiceSynchronousImpl implements PersistenceService {

    private static final Logger LOG = LoggerFactory.getLogger(PersistenceServiceSynchronousImpl.class);
